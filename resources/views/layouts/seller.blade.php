...
<body>
    ...
    <!-- Page content -->
    <div class="page-content login-cover" style=" background: url({{ asset('public/all/admin') }}/global_assets/images/login_cover.jpg) no-repeat;">
        ...
        <div class="content-wrapper">
            ...
            <div class="content d-flex justify-content-center align-items-center">
                ...
                <form class="login-form wmin-sm-400"
                    action="http://demo.interface.club/limitless/demo/Template/layout_1/LTR/default/full/index.html">
                    <div class="card mb-0">
